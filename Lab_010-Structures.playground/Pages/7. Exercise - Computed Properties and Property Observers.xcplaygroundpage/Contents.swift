...
struct Height {
    var heightInInches: Double {
        didSet {
            let oldValueInCentimeters = heightInInches * 2.54
            if oldValueInCentimeters != heightInCentimeters {
                heightInCentimeters = oldValueInCentimeters
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            let oldValueInInches = heightInCentimeters / 2.54
            if oldValueInInches != heightInInches {
                heightInInches = oldValueInInches
            }
        }
    }
