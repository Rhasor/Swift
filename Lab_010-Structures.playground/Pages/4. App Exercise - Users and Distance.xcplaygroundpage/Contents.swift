...
var name=User(name: "John", age: 30, height: 1.78, weight: 75, activityLevel: 7)
print(name)
...
print("distance in feets: \(mile.feet)")
print("distance in meters: \(mile.meters)")
//:  Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
var mile1=Distance(feet: 5249.344)
print("distance in feets: \(mile1.feet)")
print("distance in meters: \(mile1.meters)")

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var km=Distance(meters: 1000)
print("distance in feets: \(km.feet)")
print("distance in meters: \(km.meters)")
