...
var myRun = RunningWorkout(distance: 5.2, time: 30.5, elevation: 120.0)
print(myRun.postWorkoutStats())
...
print("see the steps increased by one: \(mySteps.steps) \(mySteps.takeStep())")
